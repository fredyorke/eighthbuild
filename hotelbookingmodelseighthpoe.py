...
from statsmodels.tsa.arima.model import ARIMA  # Ensure this import is included
...
if uploaded_file:
    ...
    if st.button("Forecast"):
        ...
        if model_choice == "ARIMA":
            ...
            rmse, mae, mape = evaluate(test.values, forecast['yhat'].iloc[-forecast_period:].values)
        elif model_choice == "LSTM":
